...
export const Comments = (props: ICommentsProps) => {
  ...
  const { commentsList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="comments-heading">
        <Translate contentKey="gamePortalApp.comments.home.title">Comments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gamePortalApp.comments.home.createLabel">Create new Comments</Translate>
        </Link>
      </h2>
        ...
        {commentsList && commentsList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('gamename')}>
                  <Translate contentKey="gamePortalApp.comments.gamename">Gamename</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('comment')}>
                  <Translate contentKey="gamePortalApp.comments.comment">Comment</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gamePortalApp.comments.home.notFound">No Comments found</Translate>
            </div>
          )
        )}
      </div>
